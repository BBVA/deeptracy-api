...
Feature: Read projects
  ...
  Scenario Outline: Get a project by id
    ...
    Examples:
      ...
      | 0000001         |  /api/1/project/0000001            | 200                 |  {"id": "ID", "repo": "http://test0000001.com", "scans": 0, "hookData": "", "hookType": "NONE", "authType": "PUBLIC"}  |  empty    |
  ...
  Scenario: Get projects
    ...
    And the api response payload is [{"repo": "http://test0000001.com", "scans": 0, "hookData": "", "hookType": "NONE", "authType": "PUBLIC"}]
